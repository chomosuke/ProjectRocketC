...
class RegularPolygonalShape(val numberOfEdges: Int, var centerX: Float, var centerY: Float, var radius: Float, red: Float, green: Float, blue: Float, alpha: Float, buildShapeAttr: BuildShapeAttr) : Shape() {
