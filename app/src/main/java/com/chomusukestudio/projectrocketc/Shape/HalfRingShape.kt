...
class HalfRingShape(centerX: Float, centerY: Float, a: Float, b: Float, factor: Float, red: Float, green: Float, blue: Float, alpha: Float, buildShapeAttr: BuildShapeAttr) : Shape() {
