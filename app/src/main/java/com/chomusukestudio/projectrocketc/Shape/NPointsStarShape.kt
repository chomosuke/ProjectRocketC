...
class NPointsStarShape(n: Int, centerX: Float, centerY: Float, radius: Float, red: Float, green: Float, blue: Float, alpha: Float, z: Float, visibility: Boolean) : Shape() {
    ...
    init {
        ...
        componentShapes[0] = RegularPolygonalShape(n, centerX, centerY, radius * (sin(PI / 2f / n) / sin(PI - PI / 2f / n - PI / n)).toFloat(),
                red, green, blue, alpha, z, visibility) // central RegularPolygonalShape
