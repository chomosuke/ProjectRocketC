...
class NPointsStarShape(n: Int, centerX: Float, centerY: Float, radius: Float, color: Color, buildShapeAttr: BuildShapeAttr) : Shape() {
    ...
    init {
        ...
        componentShapes[0] = RegularPolygonalShape(n, centerX, centerY,
