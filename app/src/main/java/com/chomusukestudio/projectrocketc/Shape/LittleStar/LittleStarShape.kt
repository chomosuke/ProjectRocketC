...
class LittleStarShape(centerX: Float, centerY: Float, radius: Float,
                      ...
                      redCircle: Float, greenCircle: Float, blueCircle: Float, z: Float, visibility: Boolean) : Shape() {
    override val isOverlapMethodLevel: Double = 2.0 // higher than circular shape
    override var componentShapes: Array<Shape> = arrayOf(CircularShape(centerX, centerY, radius, redCircle, greenCircle, blueCircle, 1f, z, visibility)
            , NPointsStarShape(5, centerX, centerY, radius * 0.75f, redStar, greenStar, blueStar, 1f, z - 0.01f, visibility))
