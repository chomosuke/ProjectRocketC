...
val sputnikRocketQuirks      = RocketQuirks("Sputnik",       0.003f, 0.0024f, 50,   1000,   0.36f, 2,  1)
val vostokKRocketQuirks      = RocketQuirks("Vostok-K",      0.003f, 0.0033f, 100,  2000,  0.36f, 2,  1)
val saturnVRocketQuirks      = RocketQuirks("Saturn V",      0.003f, 0.003f,  200,  5000,  0.26f, 5,  1)
val spaceShuttleRocketQuirks = RocketQuirks("Space Shuttle", 0.003f, 0.0042f, 500,  10000,  0.19f, 8,  1)
val falcon9RocketQuirks      = RocketQuirks("Falcon 9",      0.003f, 0.0038f, 1000, 20000, 0.14f, 15, 1)
val falconHeavyRocketQuirks  = RocketQuirks("Falcon Heavy",  0.003f, 0.005f,  2000, 50000, 0.10f, 25, 1)
